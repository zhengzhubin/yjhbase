...
public class BulkLoadTool {
    ...
    public static void main(String...  args) throws IOException {
        ...
        String zookeeper = "10.0.xx.xxx:2181,10.0.xx.xxx:2181,10.0.xx.xxx:2181";
        ...
        conf.set("dfs.namenode.rpc-address.nameservice1.nn1", "TXIDC63-namenode1:8020");
        conf.set("dfs.namenode.rpc-address.nameservice1.nn2", "TXIDC64-namenode2:8020");
        conf.set("dfs.client.failover.proxy.provider.nameservice1",
                "org.apache.hadoop.hdfs.server.namenode.ha.ConfiguredFailoverProxyProvider");
        conf.set("dfs.ha.namenodes.hbasedfs", "nn1,nn2");
        conf.set("dfs.namenode.rpc-address.hbasedfs.nn1", "10.0.xx.xxx:9000");
        conf.set("dfs.namenode.rpc-address.hbasedfs.nn2", "10.0.xx.xxx:9000");
    ...
    private static void jvmHost() {
        String[] kuduNodes = new String[] {
                "10.0.xx.xxx,TXIDC-cluster5",
                "10.0.xx.xxx,TXIDC-cluster4",
                "10.0.xx.xxx,TXIDC-cluster3",
                "10.0.xx.xxx,TXIDC-cluster2",
                "10.0.xx.xxx,txidc-cluster1"
        };
