...
public class YjHBaseRpcControllerImpl implements HBaseRpcController {

    private static Logger LOG = LoggerFactory.getLogger(YjHBaseRpcControllerImpl.class);
    ...
    public YjHBaseRpcControllerImpl() {
        this((CellScanner) null);
    }

    public YjHBaseRpcControllerImpl(final CellScanner cellScanner) {
        this.cellScanner = cellScanner;
    }

    public YjHBaseRpcControllerImpl(final List<CellScannable> cellIterables) {
